...
Modelling detections rates between November 2015 and April 2018 for caribou, wolves, black bears, white-tailed deer, and moose.  
...
```{r, echo=FALSE}
r0 <- glmmTMB(Caribou~ LineWidth + LD1750 + VegHt + low1750*Treatment, data = det, family = nbinom1)
rSite <- glmmTMB(Caribou~ LineWidth + LD1750 + VegHt + low1750*Treatment + (1|Site), data = det, family = nbinom1) 
rMonth <- glmmTMB(Caribou~ LineWidth + LD1750 + VegHt + low1750*Treatment + (1|Month), data = det, family = nbinom1)
r2 <- glmmTMB(Caribou~ LineWidth + LD1750 + VegHt + low1750*Treatment + (1|Site) + (1|Month), data = det, family = nbinom1)
