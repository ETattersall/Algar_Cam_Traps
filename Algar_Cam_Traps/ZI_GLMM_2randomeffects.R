...
ggplot(data = WCoef, aes( x = Covariates, y = Coefficients)) + geom_point(size = 4) + geom_errorbar(aes(ymin=Coefficients - SE, ymax = Coefficients + SE))+ geom_hline(yintercept = 0)  + scale_x_discrete(limits=c("NatRegen","SPP", "HumanUse", "Low", "Snow"))+theme_classic() + theme(axis.text.x = element_text(angle = 25, hjust = 1, colour = "black", size = 16)) + theme(axis.title.x = element_text(angle = 0, colour = "black", size = 16)) + theme(axis.title.y = element_text(angle = 90, colour = "black", size = 16)) + theme(axis.text.y = element_text(colour = "black", size = 14))
...
### Removing intercept and changing font and point sizes
ggplot(data = BCoef, aes( x = Covariates, y = Coefficients)) + geom_point(size = 4) + geom_errorbar(aes(ymin=Coefficients - SE, ymax = Coefficients + SE))+ geom_hline(yintercept = 0) + scale_x_discrete(limits=c("NatRegen","SPP", "VegHt", "Low")) +theme_classic() + theme(axis.text.x = element_text(angle = 25, hjust = 1, colour = "black", size = 16)) + theme(axis.title.x = element_text(angle = 0, colour = "black", size = 16)) + theme(axis.title.y = element_text(angle = 90, colour = "black", size = 16)) + theme(axis.text.y = element_text(colour = "black", size = 14)) + ylim(-5,5)
...
ggplot(data = cab4Coef, aes(x = Covariates, y = Coefficients)) + geom_point(size = 4) + geom_errorbar(aes(ymin=Coefficients - SE, ymax = Coefficients + SE))+ geom_hline(yintercept = 0) + scale_x_discrete(limits=c("SPP", "HumanUse", "Low", "Snow"))+theme_classic() + theme(axis.text.x = element_text(angle = 25, hjust = 1, colour = "black", size = 16)) + theme(axis.title.x = element_text(angle = 0, colour = "black", size = 16)) + theme(axis.title.y = element_text(angle = 90, colour = "black", size = 16)) + ylim(-10,10) + theme(axis.text.y = element_text(colour = "black", size = 14))
