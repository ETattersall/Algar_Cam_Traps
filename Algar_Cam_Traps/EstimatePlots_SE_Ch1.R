...
ggplot(data = Blackbear, aes( x = Predictor, y = Estimate)) + geom_point() + geom_errorbar(aes(ymin= Estimate - StdError, ymax = Estimate + StdError, width = 0.3))+ geom_hline(yintercept = 0) + scale_x_discrete(limits=c("NatRegen", "Treated", "HumanUse", "Lowland", "VegHt"))+theme_classic() + theme(axis.text.x = element_text(angle = 45, hjust = 1, colour = "black", size = 14)) + theme(axis.title.x = element_text(angle = 0, colour = "black", size = 15)) + theme(axis.title.y = element_text(angle = 90, colour = "black", size = 15)) + theme(strip.text = element_text(colour = "black", size = 14)) + scale_y_continuous(limits = c(-1.25, 1.25))
...
ggplot(data = Caribou, aes( x = Predictor, y = Estimate)) + geom_point() + geom_errorbar(aes(ymin= Estimate - StdError, ymax = Estimate + StdError, width = 0.3))+ geom_hline(yintercept = 0) + scale_x_discrete(limits=Caribou$Predictor)+theme_classic() + theme(axis.text.x = element_text(angle = 45, hjust = 1, colour = "black", size = 18)) + theme(axis.title.x = element_text(angle = 0, colour = "black", size = 20)) + theme(axis.title.y = element_text(angle = 90, colour = "black", size = 20)) + theme(axis.text = element_text(colour = "black", size = 16)) + scale_y_continuous(limits = c(-4, 4))
...
ggplot(data = WTD, aes( x = Predictor, y = Estimate)) + geom_point() + geom_errorbar(aes(ymin= Estimate - StdError, ymax = Estimate + StdError, width = 0.3))+ geom_hline(yintercept = 0) + scale_x_discrete(limits=WTD$Predictor)+theme_classic() + theme(axis.text.x = element_text(angle = 45, hjust = 1, colour = "black", size = 18)) + theme(axis.title.x = element_text(angle = 0, colour = "black", size = 20)) + theme(axis.title.y = element_text(angle = 90, colour = "black", size = 20)) + theme(axis.text = element_text(colour = "black", size = 16)) + scale_y_continuous(limits = c(-2.5, 2.5))
...
ggplot(data = Wolf, aes( x = Predictor, y = Estimate)) + geom_point() + geom_errorbar(aes(ymin= Estimate - StdError, ymax = Estimate + StdError, width = 0.3))+ geom_hline(yintercept = 0) + scale_x_discrete(limits=Wolf$Predictor)+theme_classic() + theme(axis.text.x = element_text(angle = 45, hjust = 1, colour = "black", size = 18)) + theme(axis.title.x = element_text(angle = 0, colour = "black", size = 20)) + theme(axis.title.y = element_text(angle = 90, colour = "black", size = 20)) + theme(axis.text = element_text(colour = "black", size = 16)) + scale_y_continuous(limits = c(-2.5, 2.5))
...
ggplot(data = Blackbear, aes( x = Predictor, y = Estimate)) + geom_point() + geom_errorbar(aes(ymin= Estimate - StdError, ymax = Estimate + StdError, width = 0.3))+ geom_hline(yintercept = 0) + scale_x_discrete(limits=Blackbear$Predictor)+theme_classic() + theme(axis.text.x = element_text(angle = 45, hjust = 1, colour = "black", size = 18)) + theme(axis.title.x = element_text(angle = 0, colour = "black", size = 20)) + theme(axis.title.y = element_text(angle = 90, colour = "black", size = 20)) + theme(axis.text = element_text(colour = "black", size = 16)) + scale_y_continuous(limits = c(-2, 2))
...
ggplot(data = Moose, aes( x = Predictor, y = Estimate)) + geom_point() + geom_errorbar(aes(ymin= Estimate - StdError, ymax = Estimate + StdError, width = 0.3))+ geom_hline(yintercept = 0) + scale_x_discrete(limits=Moose$Predictor)+theme_classic() + theme(axis.text.x = element_text(angle = 45, hjust = 1, colour = "black", size = 18)) + theme(axis.title.x = element_text(angle = 0, colour = "black", size = 20)) + theme(axis.title.y = element_text(angle = 90, colour = "black", size = 20)) + theme(axis.text = element_text(colour = "black", size = 16)) + scale_y_continuous(limits = c(-1.5, 1.5))
