...
S1 <- lm(SnowDays~ActiveDays,data=DF)
summary(S1) #low R^2, but ActiveDays has significantly positive effect on SnowDays.

## Divide SnowDays/ActiveDays for a proportional covariate
DF$pSnow <- DF$SnowDays/DF$ActiveDays
summary(DF$pSnow)
